...
WORKDIR /templates/service/host/EasyAbp.Abp.Trees.Host
RUN dotnet restore
RUN dotnet ef migrations script -i -o migrations-Trees.sql
...
COPY --from=build /templates/service/host/EasyAbp.Abp.Trees.Host/migrations-Trees.sql migrations-Trees.sql
